...
uri = os.path.join(path, 'plant_data.txt')
...
print (targetValueRange) # ['ok' 'settler' 'solids']
featureRange = ['SS-IN', 'SED-IN', 'COND-IN', 'SS-OUT', 'SED-OUT', 'COND-OUT']
featureRange = datasetColumns[:-1]
print (featureRange) # ['SS-IN' 'SED-IN' 'COND-IN' 'SS-OUT' 'SED-OUT' 'COND-OUT']
...
# print ("==== Query ====\n", framedQuery)
# print ("==== Predictions ====")
print ("Naiive Bayes Model: ", basicNaiveBayesModel( dataset, myQuery, featureRange, targetName, targetValueRange, "printnormal" ))
# print ("Prediction result by Normal distrbution: ", basicNaiveBayesModel( dataset, myQuery, featureRange, targetName, targetValueRange, "normal" ))
